...
def plot_cn(cn_axes, x, cn, vert=[-100], genes=["ATRX"], chrom="Chromosome"):
    """Plot copy number"""
...
def plot_sv_diagram(x, cn, fusions, outfile, vert=[-100], genes=["ATRX"],chrom="test", **kwargs):
    ...
    plot_cn(cn_axes, x, cn, vert, genes, chrom)
